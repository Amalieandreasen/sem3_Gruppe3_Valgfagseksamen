<!-- Her henter vi vores stylesheets og Javascript filer og aktiviterer dem med en add_action -->
<?php
function customThemeFiles()
{
    ...
    wp_enqueue_script('filter.js', get_theme_file_uri('/JS/filter.js'), array(), null, true);
}
